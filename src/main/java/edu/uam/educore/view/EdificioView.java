...
public class EdificioView extends VistaBase {
    ...
    private void registrarEdificio() {
        ...
        String codigo =
                leerTexto("Código del edificio");

        String nombre =
                leerTexto("Nombre del edificio");
    ...
    private void agregarAulaAEdificio() {
        ...
        int opcionTipo =
                leerEntero("Seleccione una opción");

        try {

            TipoAula tipo =
                    TipoAula.values()[opcionTipo];
    ...
    private void listarAulasDeEdificio() {
        ...
        try {
            ...
            Edificio edificio =
                    controller.buscarPorId(idEdificio);

            if (edificio == null) {

                mostrarError(
                        "No existe edificio con ID "
                        + idEdificio);
            ...
            if (aulas.isEmpty()) {
                ...
                mostrarMensaje(
                        "Este edificio no tiene aulas registradas");
    ...
    private void eliminarAulaDeEdificio() {
        ...
        String confirmacion =
                leerTexto("¿Está seguro de eliminar el aula? (S/N)");
